  ...
  return (
    <>
      ...
      <div className="flex min-h-screen flex-col bg-surface">
        <header className="sticky top-0 z-20 flex h-16 w-full items-center justify-between border-b border-outline-variant bg-surface-container-lowest/50 px-6 backdrop-blur-md">
        ...
        <main className="relative flex flex-grow items-center justify-center p-6">
          ...
          <div className="absolute inset-0 z-0 overflow-hidden" aria-hidden="true">
            <div className="absolute left-[10%] top-[10%] h-[30%] w-[30%] rounded-full bg-primary/10 blur-[120px]" />
            <div className="absolute bottom-[10%] right-[10%] h-[30%] w-[30%] rounded-full bg-primary/5 blur-[120px]" />
          </div>
